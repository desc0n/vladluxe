...
<div class="container">
  ...
  <div class="header">
    ...
    <ul class="pull-right">
      <li><a href="/buysalerent">Купить</a></li>
      <li><a href="/buysalerent">Продать</a></li>
      <li><a href="/buysalerent">Аренда</a></li>
    </ul>
  </div>
  <!-- #Header Starts -->
</div>
        ...
        <div class="sl-slider">
          ...
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">2 спальные комнаты и 1 столовая на продажу</a></h2>
              <blockquote>              
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> Маковского 120</p>
              <p>Идеальный вариант</p>
              <cite>20 000 000 руб.</cite>
              </blockquote>
            </div>
          </div>
...
<!-- banner -->
<div class="container">
  <div class="properties-listing spacer"> <a href="/buysalerent" class="pull-right viewall">Все предложения</a>
